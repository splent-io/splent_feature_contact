"""
End-to-end tests for splent_feature_contact.
...
Run with:  splent feature:test splent_feature_contact --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_contact")
    assert "splent_feature_contact" in browser.page_source.lower()
